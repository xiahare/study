...
public class HiveStatement implements java.sql.Statement {
    ...
    TGetOperationStatusResp waitForOperationToComplete() throws SQLException {
        System.out.println(String.format("----Enter waitForOperationToComplete"));
        TGetOperationStatusReq statusReq = new TGetOperationStatusReq(stmtHandle);
        ...
        if (!shouldGetProgressUpdate) {
             ...
             */
            System.out.println(String.format("----A ---- progressBarCompleted"));
            inPlaceUpdateStream.getEventNotifier().progressBarCompleted();
            System.out.println(String.format("----B ---- progressBarCompleted"));
        }
        TGetOperationStatusResp statusResp = null;
        ...
        while (!isOperationComplete) {
            try {
                ...
                sw.stop();
                System.out.println(String.format("----: [%d]ms, Status:[%s]", sw.getTime(), statusResp.getOperationState()));
    ...
    */
        System.out.println("--- C --- progressBarCompleted");
        inPlaceUpdateStream.getEventNotifier().progressBarCompleted();
        return statusResp;
    }
    ...
    public int getUpdateCount() throws SQLException {
         ...
         * finished.
         */
        System.out.println("---- Enter getUpdateCount->waitForOperationToComplete");
